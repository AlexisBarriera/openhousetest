      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            <h3 className="font-heading text-2xl mb-2">Lion Tech LLC.</h3>
            <p className="text-gray-400 text-sm">Servicios de programacion y pagina web</p>
          </div>
        ...
        <div className="border-t border-gold/20 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">© 2025 Lion Tech LLC. Todos los derechos reservados.</p>
